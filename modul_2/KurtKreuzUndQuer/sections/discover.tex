...
Während die Identify-Phase den Problemraum aus der Vogelperspektive vermessen hat (\gls{deskresearch}, \gls{stakeholdermap}, \gls{designspace}), öffnet die Discover-Phase die erste Raute des \gls{doublediam} hin zur Zielgruppe selbst. Ziel war es, die offen gebliebenen Annahmen und Wissenslücken empirisch zu prüfen und die Lebenswelt frisch pensionierter Menschen aus erster Hand zu verstehen, also \emph{mit} der Zielgruppe zu sprechen statt \emph{über} sie.

Konkret verfolgten wir drei Erkenntnisziele: das Mobilitätsverhalten und die Entscheidungslogik zwischen \gls{miv} und \gls{oev} nachzuvollziehen, die emotionalen wie praktischen Barrieren und Motivatoren der \gls{oev}-Nutzung freizulegen sowie unsere Identify-Hypothesen zu prüfen. Die Phase ist bewusst divergent angelegt: Wir sammelten breit und unvoreingenommen, bevor in der Define-Phase verdichtet wird.

\subsection{Eingesetzte Methoden und Vorgehen}

Im Zentrum stand die qualitative Primärforschung: Wir kombinierten \gls{leitfadeninterview}s mit einem ergänzenden standardisierten Fragebogen sowie KI-generierten \emph{Synthetic Users} und werteten das Material mit \gls{empathymap} und \gls{paingain} aus. Dem Profil des CAS entsprechend setzten wir gezielt KI-Werkzeuge unterstützend ein.

\subsubsection{Qualitative Leitfadeninterviews}

Als Leitmethode wählten wir das halbstandardisierte \gls{leitfadeninterview} \parencite{blume2025}, das die Innensicht der Befragten zugänglich macht. Der Leitfaden entstand in einem fünfstufigen Vorgehen (Ziele bestimmen, Vorwissen sichten, entwerfen, Pilotphase, Interviewserie) und umfasste rund 30 Minuten mit sechs Blöcken, von Warm-up über Verhalten und Barrieren bis zur digitalen Nutzung. Grundregeln waren: keine Suggestiv- oder reinen Ja/Nein-Fragen, ein sparsames ``Warum?'' und stets nur eine Frage auf einmal. Die halbstandardisierte Form hält die Perspektiven vergleichbar, lässt aber Raum, unerwarteten Spuren zu folgen.

\subsubsection{Ergänzende Quellen und KI-Einsatz}

Um die qualitative Basis zu verbreitern, überführten wir den Leitfaden zusätzlich in einen standardisierten Fragebogen, der per E-Mail an weitere Personen der Zielgruppe verschickt wurde. Passend zum Fokus des CAS auf \gls{designthinking} mit künstlicher Intelligenz nutzten wir generative Werkzeuge an mehreren Stellen: ChatGPT als Sparringpartner beim Leitfaden, einen KI-basierten \emph{Virtual Trainer} zum Üben der Gesprächsführung sowie \emph{Synthetic Users} als KI-generierte Persona-Stellvertreter. Diese Hinweise verstanden wir bewusst als Ergänzung und nicht als Ersatz der echten Stimmen.

\subsubsection{Stichprobe, Durchführung und Synthese}

Den qualitativen Kern bilden zwei selbst geführte 30-minütige Tiefeninterviews im Rahmen der \emph{Testing Time} mit \textbf{Margrit} und \textbf{Hans Jörg}, beide frisch pensioniert. Ergänzt um die Videointerviews der übrigen Projektteams lagen insgesamt acht Gespräche mit den beiden vor, dazu die Rückläufe aus Fragebogen und Synthetic Users. Zur Verdichtung der Rohdaten nutzten wir zwei Synthese-Werkzeuge: Die \gls{empathymap} ordnet die Aussagen in die Quadranten \emph{Hear}, \emph{See}, \emph{Think \& Feel} und \emph{Say \& Do} und macht das Spannungsfeld zwischen Aussage und Verhalten sichtbar; die \gls{paingain} stellt Schmerzpunkte und Motivatoren gegenüber und bereitet die Priorisierung von Hebeln für die Develop-Phase vor.

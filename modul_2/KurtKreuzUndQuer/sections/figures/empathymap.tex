...
\begin{tikzpicture}[
    x=1cm, y=1cm,
    lcard/.style={
      rounded corners=2pt, draw=mmInk, line width=0.55pt, fill=definePastel,
    ...
    rcard/.style={
      rounded corners=2pt, draw=mmInk, line width=0.55pt, fill=defaultPastel,
      text=mmInk, font=\scriptsize\itshape, align=left,
  ...
  % ================= Kopfzeile =================
  \node[anchor=north west, draw=mmInk, line width=0.55pt, fill=white,
        text=mmInk, font=\normalsize\bfseries\itshape,
        align=center, text width=224mm, inner sep=2mm, rounded corners=2pt]
        (hdr) at (0,0)
    {Empathy Map \quad|\quad Pensionierte (über 65 Jahre ) \quad|\quad Zielgruppe: ZVV-Fallstudie ``Mobilität für vitale Senior:innen''};
  ...
  % ================= SAY \& DO (Mitte unten) =================
  \begin{scope}[mcard/.append style={fill=identifyPastel}]

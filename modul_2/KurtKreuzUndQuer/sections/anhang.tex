...
\clearpage
\AnhangBild{ressourcen/identify/stakeHolderMap.png}{Stakeholder Map mit Kernnutzer:innen, direktem Umfeld und weiteren Akteur:innen.}
...
\begin{itemize}[nosep]
  ...
  \item X Proband:innen via Martinas Fragebogen
\end{itemize}
...
\begin{enumerate}[nosep]
  ...
  \item Vorhandenes Vorwissen sichten (Literatur, KI-Recherche, Expert:innen).
...
\begin{itemize}[nosep]
  ...
  \item Wie könnten wir Kurt Zugehörigkeit vermitteln, wenn er mit Vereinskolleg:innen eine Ausflugsstrecke plant und einsteigt?

...
\textit{``Standard bei mir ist die ÖV. Zug, Tram, Bus --- das macht doch einfach Sinn. Das Auto kommt zum Einsatz, wenn ich muss --- schwere Einkäufe, spät in der Nacht ohne Anschluss. Ich bin in Vereinen tätig und gesellig, das geht im ÖV halt auch am besten.''}
...
\begin{center}
\begin{tabular}{ll}
Alter & 65--80 Jahre (frisch pensioniert) \\
Wohnort & Seegemeinde / städtische Agglo Zürich \\
Beruf (i.R.) & Technisch / handwerklich (Elektriker, Mechaniker, Ing.) \\
Mobilität & ÖV (Freizeit \& Alltag) · Auto (Ausnahme) \\
ÖV-Abo / Digital & Halbtax oder GA · SBB-App, ZVV-App, MeteoSwiss, WebCams
\end{tabular}
\end{center}
...
\textbf{ÖV als natürliches Default:} ÖV ist erste Wahl für alle Wege. Auto kommt nur bei echtem Nutzen: schwere Einkäufe für den Garten, späte Nacht ohne Anschluss.

\textbf{Kritisch bei Komplexität:} Grundsätzlich ÖV-affin, ärgert sich aber über komplizierte Zonensysteme und unlogische Ticketregeln.
...
\textbf{Recherche \& Eigeninitiative:} Bei unklaren ÖV-Systemen wird selbst recherchiert; Ausflüge werden mit Höhenmetern und Webcams geplant --- das macht Spass und hält geistig fit.
...
\subsection{Customer Journey: ÖV-Ausflug mit der Gruppe}
...
Wir wählten die typische ÖV-Nutzung der Persona ``Kurt'' ab: vom Gedanken eine Reise unternehmen zu wollen, bis zum Abschluss der Reise mit der Reflexion.
...
\subsubsection{Persona 2: Maria Mobil (65--75 Jahre, ländlicher Raum)}
...
\textbf{Charakteristiken:} Aktive, kaufkräftige Seniorin im ländlichen Raum. Das öV-Angebot ist nicht attraktiv genug --- lange Wartezeiten, keine Direktverbindungen. Hürde ist nicht psychologisch, sondern systemisch. Sie würde öV nutzen, wenn das Angebot besser wäre.
...
& Kurt (aktiv, urban, öV-affin) & Maria (aktiv, ländlich, öV-skeptisch) & Heinz (betagter, unsicher, Transition) \\
\hline
Alter & 65--75 & 65--75 & 75--85 \\
Wohnort & urban & ländlich & urban/suburban \\
Status & ÖV-Nutzer & Auto-Nutzer & Transition \\
